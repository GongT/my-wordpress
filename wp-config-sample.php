...
/** WordPress 的數據庫名稱，請更改 "database_name_here" */
define('DB_NAME', 'database_name_here');

/** MySQL 數據庫使用者名稱，請更改 "username_here" */
define('DB_USER', 'username_here');

/** MySQL 數據庫密碼，請更改 "password_here" */
 ...
 * WordPress 數據表前綴。
 *
 * 若您為每個 WordPress 設定不同的資料表前綴，則可在同個數據庫內安裝多個 WordPress。
 * 前綴只能使用半型數字、字母和底線！
 */
$table_prefix  = 'wp_';
...
/* 設定完成，不要編輯下面的東西，並儲存檔案，然後開始 Blogging 吧！ */
